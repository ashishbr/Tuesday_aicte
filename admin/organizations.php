        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="organization.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> Organization </a>
              ...
              <a href="events_logs.php" class="list-group-item"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> Deleted events </a>
          </div>
          </div>
          <div class="col-md-9">
            <!-- Website Overview -->
                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                       ...
                       while($row = mysqli_fetch_array($res)){
                        ...
                        $id =  $row["id"];
                        echo "<td>"; echo "<a class='btn btn-default' href='edit_event.php?id= $id'>Edit</a> <a class='btn btn-primary' href='delete_organization.php?id= $id'>Delete</a>"; echo" </td>";
                        echo "</tr>";
                       }
                      ?>
                    </table>
