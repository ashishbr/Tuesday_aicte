        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="organizations.php" class="list-group-item"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> Organizations </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="form-group">
        ...
        <div class="form-group">
          <label>USN</label>
          <input type="usn" name="usnid" class="form-control" placeholder="usn" required>
        </div>
        <div class="form-group">
...
if(isset($_POST['submit'])){ 
 ...
 elseif(mysqli_num_rows($db_phone)!=0){
  ...
  $sql_adduser = "INSERT INTO `user`(`name`, `usn`, `phone_number`, `password`, `usertype`,`dt`) values ('$name','$usn' ,'$phone_number','$password','$usertype',current_timestamp() );";
