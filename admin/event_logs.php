...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Deleted Events</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> Deleted events</h1>
            </div>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="event_logs.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> Deleted events </a>
